namespace MvcMusicStore.DataContexts.MusicMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MvcMusicStore.DataContexts.MusicDb>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"DataContexts\MusicMigrations";
        }

        protected override void Seed(MvcMusicStore.DataContexts.MusicDb context)
        {
